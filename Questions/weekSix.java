...
class weekSix {
    ...
    private static boolean helper(String unique, int idx, String[] words, String result, boolean[] usedNum, int[] charMap, boolean[] flag){
   ...
   // Function to generate the unique word
   static  private String generateUniqueWord(String[] words, String result){
